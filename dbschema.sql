...
ADD COLUMN lead_owner VARCHAR(255) DEFAULT NULL,
...
ADD COLUMN lead_source VARCHAR(255) DEFAULT NULL,
ADD COLUMN tier VARCHAR(50) DEFAULT NULL,
ADD COLUMN lead_status VARCHAR(100) DEFAULT NULL,
ADD COLUMN insta VARCHAR(255) DEFAULT NULL,
ADD COLUMN social_profile VARCHAR(255) DEFAULT NULL,
ADD COLUMN address VARCHAR(255) DEFAULT NULL,
ADD COLUMN description_information TEXT DEFAULT NULL,
ADD COLUMN whatsapp VARCHAR(100) DEFAULT NULL,
ADD COLUMN next_step TEXT DEFAULT NULL,
ADD COLUMN other TEXT DEFAULT NULL,
ADD COLUMN status VARCHAR(100) DEFAULT NULL,
ADD COLUMN country VARCHAR(100) DEFAULT NULL,
ADD COLUMN sdr_name VARCHAR(255) DEFAULT NULL;
